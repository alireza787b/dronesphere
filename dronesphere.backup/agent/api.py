...
async def health():
    ...
    try:
        ...
        try:
            ...
            current_command = agent.runner.get_current_execution() if agent.runner else None
        ...
        return {
            ...
            "current_command": current_command.id if 'current_command' in locals() and current_command else None,
