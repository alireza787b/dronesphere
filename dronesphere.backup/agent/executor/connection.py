...
class DroneConnection:
    ...
    async def connect(self) -> None:
        ...
        try:
            logger.info("connecting_to_drone", 
            ...
            logger.error("drone_connection_failed", drone_id=self.drone_id, error=str(e))
    ...
    async def disconnect(self) -> None:
        ...
        try:
            ...
            logger.error("drone_disconnection_error", drone_id=self.drone_id, error=str(e))
