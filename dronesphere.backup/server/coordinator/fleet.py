...
class FleetManager:
    ...
    async def _check_drone(self, drone: DroneInfo) -> None:
        ...
        try:
            ...
            if connected:
                ...
                # Get health status
                health = await self.client.get_agent_health(drone.agent_host, drone.agent_port)
                if health:
    ...
    def get_drone(self, drone_id: int) -> Optional[DroneInfo]:
        """Get drone by ID."""
