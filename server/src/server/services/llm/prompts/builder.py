...
class PromptBuilder:
    ...
    def _get_template(self, name: str, template_class: Type[BasePromptTemplate]) -> BasePromptTemplate:
        ...
        for cmd in commands:
            ...
            for param_name, param_spec in params.items():
                ...
                if required:
                    ...
                    param_list.append(f"{param_name} ({param_type}, optional, default={default})")
    ...
    def _customize_for_language(self, template: BasePromptTemplate, language: str) -> None:
        """Add language-specific customizations."""
