...
class ExtractedCommand(BaseModel):
    ...
    parameters: Dict[str, Any] = Field(
        ...
        description="Command parameters extracted from user input"
    )
    ...
    original_phrase: str = Field(
        default="",
        description="The part of user input that triggered this command"
    )
...
class CommandExtractionOutput(BaseModel):
    ...
    commands: List[ExtractedCommand] = Field(
        ...
        description="List of extracted commands in order"
    )
...
"""
            ...
            response_text = await self.generate_response(prompt, clarification_request.context)
...
"""
    ...
    async def check_health(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            test_messages = [SystemMessage(content="Respond with 'OK' if you receive this.")]
    ...
    def _build_command_examples(self, available_commands: List[Dict[str, Any]]) -> str:
        ...
        for cmd in available_commands:
            ...
            # Get examples
            cmd_examples = cmd.get("spec", {}).get("description", {}).get("examples", [])
            example_texts = []
...
""")
    ...
    def _create_error_response(self, user_input: str, error: str) -> CommandExtractionResult:
        """
