...
class AbstractBackend(abc.ABC):
    ...
    async def goto_position(
        self, position: Position, yaw: float | None = None
    ) -> None:
...
class BackendFactory:
    ...
    @classmethod
    def create_backend(
        cls, backend_type: str, drone_id: int, connection_string: str
    ) -> AbstractBackend:
    ...
    def create_telemetry_provider(
        cls, provider_type: str, drone_id: int, connection_string: str
    ) -> TelemetryProvider:
