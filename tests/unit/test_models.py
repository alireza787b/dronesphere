...
class TestCommandRequest:
    ...
    def test_valid_command_request(self):
        ...
        cmd = CommandRequest(name="takeoff", params={"altitude": 10.0})
...
class TestTelemetry:
    ...
    def test_minimal_telemetry(self):
        ...
        telemetry = Telemetry(drone_id=1, state=DroneState.CONNECTED)
    ...
    def test_full_telemetry(self):
        ...
        position = Position(latitude=47.6062, longitude=-122.3321, altitude_msl=56.0)

        telemetry = Telemetry(
            drone_id=1, state=DroneState.FLYING, armed=True, position=position
        )
...
class TestPosition:
    ...
    def test_gps_position(self):
        """Test GPS position."""
        pos = Position(latitude=47.6062, longitude=-122.3321, altitude_msl=56.0)
    ...
    def test_local_position(self):
        ...
        pos = Position(north=10.0, east=5.0, down=-3.0)
...
class TestCommandResult:
    ...
    def test_successful_result(self):
        ...
        result = CommandResult(
            success=True, message="Command completed successfully", duration=5.2
        )
    ...
    def test_failed_result(self):
        ...
        result = CommandResult(
            success=False, message="Command failed", error="Connection lost"
        )
